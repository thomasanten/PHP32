...
<section class="row fullWidth logo">
      <div class="small-10 small-centered columns"> <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" id="Layer_1" x="0px" y="0px" width="250px" height="200px" viewBox="5.0 -10.0 100.0 135.0" enable-background="new 0 0 100 100" xml:space="preserve" fill="#fff">
        <g>
    ...
    <div class="large-6 large-centered columns">
        ...
        <div class="row">
            ...
            <form>
                ...
                <div class="large-2 columns"> <a href="#" data-reveal-id="regModal" >Register</a> </div>
              </div>
                </form>
          </div>
            </div>
   ...
   <div id="regModal" class="reveal-modal" data-reveal>
    ...
    <section id="test" style="background-color:#ecf0f1;">
