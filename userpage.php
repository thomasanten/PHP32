      ...
      <?php
		...
		if (isset($_POST['submit'])) {
						...
						<section class="row fullWidth">
							<div class="small-10 large-centered text-center columns">
								...
								if(in_array($_FILES['filename']['type'],$mimes)){
									...
									echo '<a href="userpage.php" class="button">Go Back</a>';
								}else{
		  ...
		  <?php
			...
			unset($_POST['submit']);
			if($regStatus === 'admin'){
				print'<h2>Admin</h2><p> Add an user by uploading a <a href="#" data-reveal-id="csvForm">CSV</a> file!</p>';	
			}
				?>
            <h2>Personal</h2>
            <p>No data added yet! Tell us more about yourself by adding it Manually.. </p>
  ...
  <section class="row">
	...
	<section class="row">
        <div class="large-6 small-10 small-centered text-center columns">
              <h2>Your Hair</h2>
              <?php
              	$userHair = 'hair_'.$userHlength[0].'.'.$userHcolor.'.png';
